...
<head>
  ...
  <title>星火混合式柏青哥 V6.5｜周圍彈性撞擊版</title>
...
<div class="app">
  ...
  <aside class="hud">
    <div>
      <div class="logo">星火 HYBRID PACHINKO</div>
      <div class="sub">長按蓄力發射。上方保持完全開放，彈珠進入撞針區後會與周圍彈性撞擊物、旋轉撥輪、彈板及救球桿持續互動；擊中 GOLD LOCK 可釋放所有得分 ×10 的黃金彈珠。</div>
    </div>
    ...
    <div class="card legend">
      ...
      <span><i class="dot" style="color:#69ffb5;background:#69ffb5"></i>周圍彈性撞擊物：將彈珠送回撞針區</span>
...
<script src="./v6-perimeter-rebound.js" defer></script>
